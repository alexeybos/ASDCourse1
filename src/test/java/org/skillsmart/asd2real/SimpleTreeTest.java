...
class SimpleTreeTest {
    ...
    void testSetLevels() {
        ...
        assertEquals(1, tNode1.level);
        assertEquals(2, tNode2.level);
        assertEquals(2, tNode3.level);
        assertEquals(1, tNode4.level);
        assertEquals(2, tNode5.level);
        assertEquals(3, tNode6.level);
        SimpleTree<Integer> tree = new SimpleTree<>(null);
        tree.setLevels();
        SimpleTreeNode<Integer> node = new SimpleTreeNode<>(111, null);
        tree = new SimpleTree<>(node);
